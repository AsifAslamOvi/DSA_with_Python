...
# installed.
TCL_PREFIX='F:/Personal/DSA in Python/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='F:/Personal/DSA in Python/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='F:/Personal/DSA in Python/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IF:/Personal/DSA in Python/venv\Library\include'
...
TCL_PACKAGE_PATH='F:/Personal/DSA in Python/venv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LF:/Personal/DSA in Python/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='F:/Personal/DSA in Python/venv\Library\lib\tclstub86.lib'
